                    ...
                    <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div className="text-center p-4 bg-purple-50 rounded-lg">
                                <span className="material-symbols-outlined text-4xl text-purple-600 mb-2">
                                    psychology
                                </span>
                                <h3 className="font-semibold text-gray-800 mb-1">Smart Entity Recognition</h3>
                                <p className="text-sm text-gray-600">
                    ...
                    <div className="bg-white rounded-xl shadow-lg p-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="bg-gray-50 rounded-lg p-6 text-center">
                                <div className="mb-4">
                                    <button className="bg-red-500 hover:bg-red-600 text-white px-6 py-3 rounded-full font-medium transition-colors transform hover:scale-105 flex items-center mx-auto">
                                        <span className="material-symbols-outlined mr-2">mic</span>
                                        Start Recording
                                    </button>
                                </div>
                                <p className="text-sm text-gray-600 mb-2">Click to begin live audio recording</p>
